...
const gchar* authors[] = { 
	"Amanda Graven <amanda@amandag.net>",
	NULL
};
...
static void activate_about(GSimpleAction* action, GVariant* parameter, gpointer app) {
	...
	gtk_show_about_dialog(window,
		...
		"authors",        authors,
		"copyright",      "Copyright (C) 2016 Amanda Graven and contributors",
...
static void main_app_startup(GApplication* app) {
	...
	GtkBuilder* builder;
	GMenuModel* menu;
	builder = gtk_builder_new_from_resource("/net/agraven/test/menu.ui"); 
...
MainApp* main_app_new(void) {
	return g_object_new(MAIN_APP_TYPE,
		"application-id", "net.agraven.test","flags",
